...
list_enrichr_UP %>%
  write_tsv("../../out/table/enrichR_DE_UP_woBackground.tsv")
...
# save the results
list_enrichr_DOWN %>%
  write_tsv("../../out/table/enrichR_DE_DOWN_woBackground.tsv")
...
ggsave("../../out/plot/enrichR_DE_UP_woBackground.pdf",width = 7,height = 15,limitsize = FALSE)
...
ggsave("../../out/plot/enrichR_DE_DOWN_woBackground.pdf",width = 7,height = 15,limitsize = FALSE)
