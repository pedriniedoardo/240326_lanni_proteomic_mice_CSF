...
dbs_db <- c("KEGG_2021_Human","MSigDB_Hallmark_2020","Reactome_2022","WikiPathway_2023_Human","HDSigDB_Human_2021","GO_Biological_Process_2023")
...
list_enrichr_UP %>%
  write_tsv("../../out/table/enrichR_DE_pseudobulk_UP.tsv")
...
list_enrichr_DOWN %>%
  write_tsv("../../out/table/enrichR_DE_pseudobulk_DOWN.tsv")
...
ggsave("../../out/plot/enrichR_DE_pseudobulk_UP.pdf",width = 6,height = 12,limitsize = FALSE)
...
ggsave("../../out/plot/enrichR_DE_pseudobulk_DOWN.pdf",width = 6,height = 12,limitsize = FALSE)
